...
pacstrap -K /mnt base linux linux-firmware intel-ucode intel-media-driver lvm2 cryptsetup exfatprogs iwd man-db man-pages grub efibootmgr vim htop mc ansible git python-passlib openssh zerotier-one fastfetch
